...
- Real-time network traffic monitoring and automated security alerts using Python and open-source tools.
- Integrated NetFlow analysis for enhanced security response protocols.

### [Cloud-Based Security Configuration Tool](https://github.com/yashwanthpandi/cloud-config-tool)
- Automated security policy deployment using Terraform and AWS Security Hub.
- Streamlined cloud security operations with Infrastructure-as-Code (IaC).

### [IoT-Based Air Quality Monitoring System](https://github.com/yashwanthpandi/iot-air-quality-monitor)
- Built a scalable IoT system for environmental monitoring with a focus on network security and data integrity.
